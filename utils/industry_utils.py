...
def build_configurator_to_scrapping(año,quarter,url=None,norma=1): # eventualmente buscar ultimo año disponible por url 
    """ 
...
def generate_years_dict(desde=2005):
    """
