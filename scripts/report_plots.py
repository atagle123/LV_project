...
######################
    ...
    df_oferta_vivienda=download_excel_to_df("https://cchc.cl/uploads/indicador/archivos/GranSantiagoMercadoWeb.xls",filepath,filename="GranSantiagoMercadoWeb",sheet_name=1)
    ...
    df_dict={"Mensual":df_mensual,"Trimestral":df_trimestral} 

    download_dfs(filepath,df_dict, filename="all_data") # download df
    ...
    plots_path=os.path.join(current_dir, "data\macrodata\plots")
    ...
    plt.savefig(os.path.join(plots_path,title))
    plt.close()
